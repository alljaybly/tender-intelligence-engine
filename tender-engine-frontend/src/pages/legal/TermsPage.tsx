/**
 * TermsPage — Renders the Terms of Service markdown file.
 *
 * Fetches /terms.md at runtime and renders it as styled HTML.
      ...
      <main className="flex-1 mx-auto w-full max-w-4xl px-6 py-12 lg:px-8">
        {error && (
          <div className="rounded-lg border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-semibold text-red-800 mb-2">Error Loading Terms</h2>
        ...
        {!content && !error && (
          <div className="flex items-center justify-center py-24">
            <div className="animate-pulse text-gray-400 text-lg">Loading Terms of Service...</div>
          </div>
        )}
